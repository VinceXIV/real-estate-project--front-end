...
function Card({house}) {
    ...
    return(
    <div  className="scale-80 m-5 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        <div >
            <img style={imageStyle} className="rounded-t-lg" src={house.image} alt="" />
        </div>
        <div className="p-5">
            <div >
                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">${house.price}</h5>
                <h1 style={{fontColor: "blue"}}>{house.location}</h1>
            </div>
